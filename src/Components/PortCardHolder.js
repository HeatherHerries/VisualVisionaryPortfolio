...
function PortCardHolder({sbText, pchPara, /*pchImgs*/ pchImg1, pchImg2, pchImg3, pchImg4, pchImg5, pchImg6}) {
  ...
  return (
    <div className="port-card-holder-container">
      ...
      <div className="pch-imgs">
        ...
        {/* {pchImgs.map((pchImg, index) => <img className={`img${index + 1}`} key={index} src={pchImg.img} alt={pchImg.alt} />)} */}
